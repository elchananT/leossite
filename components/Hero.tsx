        ...
        <section className="relative flex items-center justify-center h-[85vh] min-h-[600px] w-full bg-cover bg-center" data-alt="A beautifully designed modern living room with minimalist furniture and large windows." id="home"
            ...
            <div className="container mx-auto px-6 text-center text-white">
                ...
                <div className="mt-8 flex flex-wrap justify-center gap-4">
                    <a className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-[#4A908A] text-white text-base font-bold tracking-wide shadow-md hover:bg-[#4A908A]/90 transition-all transform hover:scale-105" href="#projects">
                        <span className="truncate">View Our Portfolio</span>
                    </a>
                    <a className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-[#C0B283] text-[#36454F] text-base font-bold tracking-wide shadow-md hover:bg-[#C0B283]/90 transition-all transform hover:scale-105" href="#contact">
